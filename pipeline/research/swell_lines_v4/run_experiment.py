...
from pipeline.research.swell_lines_v4 import REPORT_PATH, RESULTS_PATH  # noqa: E402
from pipeline.research.swell_lines_v4.detect import detect_swell_lines_v4  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the v4 wavelet swell-line experiment.")
...
def evaluate_pair(
    ...
    *,
    ...
    detector=detect_swell_lines_v4,
    ...
    return {
        ...
        "spot_context": {
            "segment_id": getattr(organized_result, "segment_id", None),
            "segment_orientation_deg": getattr(organized_result, "segment_orientation_deg", None),
        },
        "organized_scene": {
            **organized_scene,
